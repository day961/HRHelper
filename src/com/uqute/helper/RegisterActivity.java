...
import com.uqute.util.ClassPathResource;
...
public class RegisterActivity extends Activity implements android.view.View.OnClickListener{
	...
	private void initView(){
		...
		tv_Server.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG);
	...
	public void onClick(View v) {
		...
		case R.id.btn_send_code:
			...
			if(chk_agree.isChecked()== false)//若没勾选checkbox无法后续操作
				Toast.makeText(this, "请确认是否已经阅读《爱帮手服务条款》", Toast.LENGTH_LONG).show();
